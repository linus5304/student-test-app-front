    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          ...
          <a href="#" class="text-xl font-bold flex items-center lg:ml-2.5">
            <img
              ...
              alt="Windster Logo"
            />
            <span class="self-center whitespace-nowrap">Student Management</span>
          </a>
        </div>
        <div class="flex items-center">
          ...
          <a
            href="#"
            class="hidden sm:inline-flex ml-5 border border-cyan-600 text-cyan-600 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center items-center mr-3"
          >
            Login
          </a>
        </div>
